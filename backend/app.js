...
import meditationRouter from './src/routes/meditation.routes.js'
import generationRouter from './src/routes/generate.routes.js'

app.use("/api/v1/users", userRouter)
app.use("/api/v1/meditation",meditationRouter)
